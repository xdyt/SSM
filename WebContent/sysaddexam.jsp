				...
				<div class="main-page">
					...
					<div class="bs-example widget-shadow"
						...
						<table class="table table-hover">
							<tr>
								<td>名称:</td>
								<td><input type="text" name="exaname" id="exaname"/></td>
								<td><span id="exaname" style="color:red"></span></td>
							</tr>
							<tr>
								<td>考试时间:</td>
								<td><input type="text" name="exatime" id="exatime"/></td>
							</tr>
							<tr>
								<td>考试类型:</td>
								<td><input type="text" name="exadata" id="exadata"/></td>
							</tr>
							<tr>
								<td>年级:</td>
								<td>
							...
							<tr>
								<td>备注:</td>
								<td>
								<textarea rows="3" cols="20" name="exarem" id="exarem"></textarea>
								</td>
							</tr>
							<tr align="right">
