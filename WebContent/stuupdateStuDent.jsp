	...
	function selectStuDent() {
		$.ajax({
			...
			success : function(data) {
				if (data == true) {
					window.location.href = 'sturealstu';
				}
			}
		});
	}
...
<body class="cbp-spmenu-push">
	...
	<form action="selset">
		<div id="page-wrapper">
			<div class="main-page">
				<h2 class="title1" align="center">修改学生信息</h2>
				<div class="grids widget-shadow">
					<div class="col-md-4 grid_box1"></div>
					<div class="row">
						<div class="col-md-4 grid_box1">
							<input type="text" class="form-control1"
								name="stuid" value="${student.stuid }"
					...
					<div class="row">
						<div class="col-md-4 grid_box1">
							<input type="text" class="form-control1"
								placeholder="请输入姓名"
								value="${student.stuname}" name="stuname" readonly="readonly" id="stuid">
						</div>
					</div>
					<div class="col-md-4 grid_box1"></div>
					<div class="row">
						<div class="col-md-4 grid_box1">
							<input type="text" class="form-control1"
								placeholder="请输入性别"
								value="${student.stusex}" name="stusex" readonly="readonly" id="stuid">
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-4 grid_box1">
							<input type="text" class="form-control1"
								placeholder="请输入QQ号码"
								value="${student.stuqq }" name="stuqq">
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-4 grid_box1">
							<input type="text" class="form-control1"
								placeholder="请输入年级"
								value="${student.stugrade }"
								name="stugrade" readonly="readonly" id="stuid">
						</div>
					</div>
					<!-- ============================提交按钮在这里========================= -->
					<button type="button" class="btn btn-primary"
						onclick="selectStuDent()">修改学生信息</button>
				</div>
			</div>
		</div>
		</div>
