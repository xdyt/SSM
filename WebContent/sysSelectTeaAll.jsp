		...
		$.ajax({
			...
			success : function(data) {
				for (var i = 0; i < data.length; i++) {
					$("#tab").append(
							"<tr><td>" + data[i].claid + "</td><td>"
									+ data[i].claname + "</td><td>"
									+ data[i].clacour + "</td></tr>");
				}
			}
		});
	}
...
<body class="cbp-spmenu-push">
	...
	<!-- main content start-->
	<!-- ============================提交路径在这里========================= -->
	<form align="center" action="cla" method="post">
		<div id="page-wrapper">
			<div class="main-page">
				<h2 class="title1" align="center">统计教师信息</h2>
					...
					<table class="table table-hover" id="tab">
						...
						<c:forEach items="${ls}" var="d" varStatus="st">
							<tr>
								...
								<td>${d.teacou}</td>
								<td>
									<%-- <a href="updateTea.jsp?teaid=${d.teaid}" class="btn btn-primary">修改</a> --%>
									<a href="delete?teaid=${d.teaid}" class="btn btn-primary">刪除</a></td>
							</tr>
						</c:forEach>
					</table>
				</div>
