...
<body class="cbp-spmenu-push">
	...
	<div class="sticky-header header-section ">
		...
		<form align="center">
			<div id="page-wrapper">
				<div class="main-page">
					<h2 class="title1" align="center">统计学生信息</h2>
						...
						<table class="table table-hover">
							...
							<c:forEach items="${user }" var="list">
								<tr align="center">
									...
									<td>${list.stugrade }</td>
									<td>
										<a href="stuselectStuid?id=${list.stuid }" class="btn btn-primary">修改</a>
										<a href="stuid?id=${list.stuid }" class="btn btn-primary">详情</a></td>
								</tr>
							</c:forEach>
						</table>
					</div>
