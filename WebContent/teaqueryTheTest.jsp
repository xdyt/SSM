...
<body class="cbp-spmenu-push">
	...
	<form align="center">
		<div id="page-wrapper">
			<div class="main-page">
				<h2 class="title1" align="center">考试信息</h2>
				<div class="bs-example widget-shadow"
					...
					<table class="table table-hover">
						...
						<c:forEach items="${user}" var="exalist">
							<tr>
								<td>${exalist.exaid}</td>
								<td>${exalist.exaname}</td>
								<td>${exalist.exatime}</td>
								<td>${exalist.exadata}</td>
								<td>${exalist.exacla}</td>
								<td>${exalist.exasub}</td>
								<td>${exalist.exarem}</td>
								<td><a href="deleteExa?exaid=${exalist.exaid}" class="btn btn-primary">删除</a></td>
							</tr>
						</c:forEach>
					</table>
				</div>
