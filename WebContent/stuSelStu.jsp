	...
	function selectStuDent() {
		$.ajax({
			...
			success : function(data) {
				if (data == true) {
					window.location.href = 'tearealstu';
				}
			}
		});
	}
...
<body class="cbp-spmenu-push">
	...
	<form action="selset">
		<div id="page-wrapper">
			<div class="main-page">
				<h2 class="title1" align="center">学生信息详情</h2>
				<div class="grids widget-shadow">
					<div class="col-md-4 grid_box1"></div>
					<div class="row">
						<div class="col-md-4 grid_box1">
							编号:<input type="text" class="form-control1"
								name="stuid" value="${stu.stuid}"
								readonly="readonly" id="stuid">
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="col-md-4 grid_box1"></div>
					<div class="row">
						<div class="col-md-4 grid_box1">
							学号:<input type="text" class="form-control1"
								name="stunum"
								value="${stu.stunum} "
								readonly="readonly" id="stuid" readonly="readonly">
						</div>
						<div class="clearfix"></div>
					</div>
					...
					<div class="row">
						<div class="col-md-4 grid_box1">
							姓名:<input type="text" class="form-control1"
								value="${stu.stuname}" name="stuname" readonly="readonly" id="stuid">
						</div>
					</div>
					<div class="col-md-4 grid_box1"></div>
					<div class="row">
						<div class="col-md-4 grid_box1">
							性别:<input type="text" class="form-control1"
								value="${stu.stusex}" name="stusex" readonly="readonly" id="stuid">
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-4 grid_box1">
							手机号:<input type="text" class="form-control1"
								value="${stu.stuphone }"
								name="stuphone" readonly="readonly" id="stuid">
						</div>
					</div>
					<div class="col-md-4 grid_box1"></div>
					<div class="row">
						<div class="col-md-4 grid_box1">
							qq:<input type="text" class="form-control1"
								value="${stu.stuqq}" name="stuqq" readonly="readonly" id="stuid">
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-4 grid_box1">
							班级:<input type="text" class="form-control1"
								value="${stu.stuclass}"
								name="stuclass" readonly="readonly" id="stuid"	>
						</div>
					</div>
					<div class="col-md-4 grid_box1"></div>
					<!-- ============================提交按钮在这里========================= -->
