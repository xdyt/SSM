				...
				<div class="grids widget-shadow">
					...
					<div class="row">
						<div class="col-md-4 grid_box1">
							<input type="text" class="form-control1" placeholder="请输入考试名称"
								id="exaname">
						</div>
						<div class="clearfix"></div>
					</div>
					...
					<div class="row">
						<div class="col-md-4 grid_box1">
							<input type="text" class="form-control1" placeholder="请输入考试时间"
								id="exatime">
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-4 grid_box1">
							<input type="text" class="form-control1" placeholder="请输入考试类型"
								id="exadata">
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-4 grid_box1">
							<textarea rows="6" cols="45" name="exarem" id="exarem"
								placeholder="请输入备注信息"></textarea>
						</div>
					</div>
					<!-- ============================提交按钮在这里========================= -->
					<button type="button" class="btn btn-primary" onclick="tianjia()">提交考试信息</button>
					<button type="reset" class="btn btn-primary">重置考试信息</button>
				</div>
			</div>
		</div>
		</div>
