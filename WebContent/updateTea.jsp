			...
			<div class="main-page">
				...
				<div class="grids widget-shadow">
					...
					<div class="row">
						<div class="col-md-4 grid_box1">
							<input type="text" class="form-control1"
								name="teaid" value="${student.teaid }"
					...
					<div class="row">
						<div class="col-md-4 grid_box1">
							<input type="text" class="form-control1"
								placeholder="请输入学号" name="teanum"
								value="${student.teanum }"
								readonly="readonly" id="stuid">
						</div>
						<div class="clearfix"></div>
					</div>
					...
					<div class="row">
						<div class="col-md-4 grid_box1">
							<input type="text" class="form-control1"
								placeholder="请输入姓名"
								value="${student.teaname}" name="teaname" readonly="readonly" id="stuid">
						</div>
					</div>
					<div class="col-md-4 grid_box1"></div>
					<div class="row">
						<div class="col-md-4 grid_box1">
							<input type="text" class="form-control1"
								placeholder="请输入性别"
								value="${student.teasex}" name="teasex" readonly="readonly" id="stuid">
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-4 grid_box1">
							<input type="text" class="form-control1"
								placeholder="请输入QQ号码"
								value="${student.teaqq }" name="teaqq">
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-4 grid_box1">
							<input type="text" class="form-control1"
								placeholder="请输入班级"
								value="${student.teacou}"
								name="teacou" readonly="readonly" id="stuid">
						</div>
					</div>
					<!-- ============================提交按钮在这里========================= -->
